<?php
  ...
  {  
    ...
    $email_inquiry = "SELECT * FROM employer WHERE user_email='".$mailTo."' ";
    ...
    else
    {
      ...
      $token = uniqid(True);
      $pwd_change = "INSERT INTO emp_request(user_token,user_email)
      VALUES('$token','$mailTo')";
      ...
      try  
      {
        ...
        // Content
        $url = "http://" . $_SERVER["HTTP_HOST"] . dirname($_SERVER["PHP_SELF"]) . "/myemp_reset.php?token=$token";

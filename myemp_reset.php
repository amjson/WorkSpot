<?php
  ...
  $token     = $_GET["token"];
  $user_email = "SELECT user_email FROM emp_request WHERE user_token = '$token' ";
  ...
  if (isset($_POST["password"])) 
  {
    ...
    else
    {
      ...
      $query     = "UPDATE employer SET user_pass='$hashedPwd' WHERE user_email='$email'";
      $run_query = mysqli_query($con, $query);


      if ($run_query) 
      {
        $Del_request = "DELETE FROM emp_request WHERE user_token = '$token' ";

      ...
      <section>
        <div class="layers">
          ...
          <div class="layerthree">
            <div class="job_cover">
              <!-- [ blueprint ] -->
              <div style="border:1px solid transparent;width:500px;height:130px;
              margin-top:50px;margin-left:90px;">
                <div class="boxOne">
                  <?php
                    $getJobs = "SELECT * FROM empostjob";
                    $result  = mysqli_query($con, $getJobs);
                    $total   = mysqli_num_rows($result);
                    
                    echo "$total";
                  ?>
                </div>
                <div class="top_boxOne">Jobs</div>

                <div class="boxTwo">
                  <?php
                    $myApp  = $_SESSION['user_email'];
                    $getApp = "SELECT * FROM canapplyjob WHERE can_email='$user'";
                    $resApp = mysqli_query($con, $getApp);
                    $application = mysqli_num_rows($resApp);
                    
                    echo "$application";
                  ?>
                </div>
                <div class="top_boxTwo">Applications</div>
              </div>

              <div style="border:1px solid transparent;width:500px;height:322px;
              margin-top:60px;margin-left:90px;">
                <div class="boxThree">
                  <form id="form">
                    <?php
                      $user        = $_SESSION['user_email'];
                      $getProfile ="SELECT * FROM candidate WHERE user_email='$user'";
                      $runProfile = mysqli_query($con, $getProfile);
                      $row         = mysqli_fetch_array($runProfile);
                    ...
                    <div class="job_body">
                      <div class="box">
                        <div class="inputWithIcon inputIconBg"> 
                          <input value="<?php echo $firstname.' '.$lastname ?>">
                      ...
                      <div class="box">
                        <div class="inputWithIcon inputIconBg">
                          <input value="<?php echo $proffesion ?>">
                ...
                <div class="top_boxThree">Account</div>
              </div>

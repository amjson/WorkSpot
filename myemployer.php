          ...
          <div class="layerthree">
            <div class="job_cover">
              ...
              margin-top:50px;margin-left:90px;">
                <div class="boxOne">
                  <?php
                    $myJobs  = $_SESSION['user_email'];
                    $getJobs = "SELECT * FROM empostjob WHERE email='$user'";
                ...
                <div class="boxTwo">
                  <?php
                    ...
                    $getApp = "SELECT * FROM canapplyjob WHERE emp_mail='$user'";

          ...
          <div class="layerthree">
            ...
            <div class="job_page">
              <?php
                ...
                $uploder = "SELECT * FROM empostjob WHERE email='".$confirm."' ";
              ...
              <?php if(mysqli_num_rows($confirm_uploder) == 0) { ?>
                ...
                font-family:Comic Sans MS;">
                  You have not uploaded any job yet
                </h4>
              <?php } else { ?>
                ...
                <?php
                  ...
                  $user          = $_SESSION['user_email'];
                  $totalEmpSQL   = "SELECT * FROM empostjob WHERE email='$user'";
                  ...
                  $getSQL = "SELECT title,type,xp,location,phone,email,id,photo, 
                  comp_name,ends,info,requirement FROM empostjob WHERE email='$user'
                ...
                <?php
                  $allJobs  = $_SESSION['user_email'];
                  $countAll = "SELECT * FROM empostjob WHERE email='$allJobs'";

          ...
          <div class="layerthree">
            ...
            <div class="job_page">
              <?php
                ...
                $uploder="SELECT * FROM canapplyjob WHERE can_email='".$confirm."'";
              ...
              <?php if(mysqli_num_rows($confirm_uploder) == 0) { ?>
                ...
                border: 1px solid transparent;margin-top:235px;
              ...
              <?php } else { ?>
                ...
                <?php
                  ...
                  $user          = $_SESSION['user_email'];
                  $totalEmpSQL = "SELECT * FROM canapplyjob WHERE can_email='$user'";
                  ...
                  $getSQL = "SELECT comp_name,emp_phone,emp_mail,can_name,can_phone,
                  can_email,can_study,can_title,can_xp FROM canapplyjob WHERE 
                  can_email='$user' LIMIT $startFrom, $showRecordPerPage ";
                    ...
                    <?php
                      ...
                      <tr class="raw"> 
                        ...
                        <td>
                          ...
                          style="padding-top:10px;"></i>
                          &nbsp&nbsp<?php echo $job['can_title'];?> <br>
                          <i class="fa fa-bar-chart-o fa-lg fa-fw" aria-hidden="true"style="padding-top:10px;"></i>
                ...
                <?php
                  ...
                  $countAll = "SELECT * FROM canapplyjob WHERE can_email='$allApplication'";
                ...
                <?php } else { ?>
                  <div aria-label="Page navigation" style="height:38px;margin-top:20px;
                  border:1px solid transparent;">
